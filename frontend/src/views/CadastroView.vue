<template>
  <div class="auth-page">
    <div class="auth-card card">
      ...
      <form @submit.prevent="registrar" class="auth-form" autocomplete="off">
        ...
        <div class="form-row">
          ...
          <div class="form-group">
            ...
            <div class="input-suffix">
              ...
              <span
                v-if="buscandoCep"
                class="spinner spinner-dark cep-spinner"
              ></span>
            </div>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <input
            ...
            autocomplete="new-password"
          />
          <span v-if="erros.confirmar" class="form-error">{{
            erros.confirmar
          }}</span>
        </div>

        <div v-if="erroGeral" class="alert alert-erro mt-1">
          ⚠️ {{ erroGeral }}
        </div>
...
const validar = () => {
  ...
  if (form.senha !== form.confirmar) {
    erros.confirmar = "Senhas não conferem";
    ok = false;
  }
  return ok;
};
