          ...
          <div class="form-section">
            ...
            <div class="form-row">
              ...
              <div class="form-group">
                ...
                <div v-if="buscandoHorarios" class="horarios-loading text-sm text-muted">🔄 Verificando...</div>
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <div style="position:relative">
                  ...
                  <span v-if="buscandoCep" class="spinner spinner-dark" style="position:absolute;right:12px;top:50%;transform:translateY(-50%)"></span>
                </div>
              </div>
              <div class="form-group">
...
const buscarClima = async () => {
  if (!form.data) return
  try {
    const { data } = await api.get('/clima', { params: { data: form.data } })
    if (data.success) clima.value = data.clima
  } catch { clima.value = null }
}
